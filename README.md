...
API предназначен для одного потока и внешнего пошагового драйвера, не для рекурсивного вызова drain из callback. Как Arc TaskQueue, при исключении callback turn прерывается; оставшиеся задачи его снимка не возвращаются в pending queue. Исключение завершает сценарий.
